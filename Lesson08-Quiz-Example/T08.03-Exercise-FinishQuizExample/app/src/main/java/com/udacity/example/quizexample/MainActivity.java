...
public class MainActivity extends AppCompatActivity {
    ...
    private String curr_description;

    private TextView word_tv;
    private TextView desc_tv;

    private int wordDescId;
    private int wordId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        word_tv = (TextView)findViewById(R.id.text_view_word);
        desc_tv = (TextView) findViewById(R.id.text_view_definition);
    ...
    public void nextWord() {
        ...
        word_tv.setText(mData.getString(wordId));
        desc_tv.setText("");
    ...
    public void showDefinition() {
        ...
        desc_tv.setText(mData.getString(wordDescId));
    ...
    public class WordFetchTask extends AsyncTask<Void, Void, Cursor> {
        ...
        protected void onPostExecute(Cursor cursor) {
            ...
            Log.e("AMIT!!","Setting data for main activity");
            mData = cursor;

            // TODO (2) Initialize anything that you need the cursor for, such as setting up
            // the screen with the first word and setting any other instance variables
            wordDescId = mData.getColumnIndex(DroidTermsExampleContract.COLUMN_DEFINITION);
