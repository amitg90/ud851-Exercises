...
public class NotificationUtils {
    ...
    public static void clearAllNotifications(Context context) {
        ...
        Log.e("Amit", "Clear Notification Called");
    ...
    public static Action ignoreReminderAction(Context context) {
        Log.e("Amit", "ignoreReminderAction Called");
    ...
    public static Action drinkWaterAction(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getService(
                ...
                intent,
                PendingIntent.FLAG_UPDATE_CURRENT);
        Action action = new Action(R.drawable.ic_drink_notification, "Increment Count", pendingIntent);
        return (action);
    }
