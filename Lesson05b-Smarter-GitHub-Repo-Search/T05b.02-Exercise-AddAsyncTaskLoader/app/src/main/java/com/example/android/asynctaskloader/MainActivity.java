...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    private static final int GITHUB_SEARCH_LOADER = 964;
    ...
    private void makeGithubSearchQuery() {
        ...
        Log.e("AMIT", "makeGithubSearchQuery!!");
    ...
    public android.support.v4.content.Loader<String> onCreateLoader(int id, final Bundle args) {
        Log.e("AMIT", "onCreateLoader called!!");

        return new android.support.v4.content.AsyncTaskLoader<String>(this) {
            @Override
            public String loadInBackground() {
                Log.e("AMIT", "loadInBackground called!!");

                String str = args.getString(SEARCH_QUERY_URL_EXTRA);
                if (str == null || TextUtils.isEmpty(str)) {
                    Log.e("AMIT", "NULL serach string!!");
                    return null;
                }
                ...
                try {
                    ...
                    URL searchUrl = new URL(str);
                    Log.e("AMIT!!!!!!", searchUrl.toString());
            ...
            protected void onStartLoading() {
                Log.e("AMIT", "onStartLoading called!!");

                super.onStartLoading();
                if (args == null) {
                    Log.e("AMIT", "onStartLoading args null!!");
                    return;
                }
    ...
    public void onLoadFinished(android.support.v4.content.Loader<String> loader, String data) {
        Log.e("AMIT", "onLoadFinished Called\n");
